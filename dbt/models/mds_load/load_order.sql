...
{#
  ...
  Entity Code: order
  Entity ID:   1
  Generated:   2026-01-12T12:29:45.556786
  
  Source: mds_stage.staged_record (JSON data)
  Target: mds_load.order (flache Tabelle)
  ...
  Die vollständige Historie wird im Master (mds_master.order)
  via SCD2 geführt.
  =====================================================
#}
...
SELECT
    ...
    sr.business_key,
    JSON_VALUE(sr.data, '$.order_id') AS order_id,
